...
var _ = Describe("Deployment", func() {
  ...
  When("Parsing YAML", func() {
      ...
      Expect(ctx).To(ProduceYAML(
        HavingContainer("uaa").RunningImage("cfidentity/uaa@sha256:93b70b26fbb3de88d93728b0daf1ea7b001fde89a24e283c3db36bf4c6af087c"),
      ))
	  })
    ...
    It("Constructs YAML from a set of files and command line values ", func() {
      ...
      Expect(ctx).To(ProduceYAML(HavingContainer("uaa").RunningImage("cfidentity/uaa@sha256:other")))
	  })
  })
